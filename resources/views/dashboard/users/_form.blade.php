<div style="width: 900px; padding: 2rem 2rem 0 2rem;">
    <div class="row">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" name="username" class="form-control" placeholder="@lang('users.username')"
                        minlength=5 maxlength=25 value="{{ $row->username ?? '' }}">
                </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" name="full_name" class="form-control" placeholder="@lang('users.full_name')"
                        minlength=5 maxlength=50 value="{{ $row->full_name ?? '' }}">
                </div>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" name="address" class="form-control" placeholder="@lang('users.address')"
                        minlength=10 maxlength=100 value="{{ $row->address ?? '' }}">
                </div>
        ...
        <div class="col-md-5">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" name="phone" class="form-control" placeholder="@lang('users.phone')"
                        value="{{ $row->phone ?? '' }}">
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="number" name="personal_id" class="form-control"
                        placeholder="@lang('users.personal_id')" min=10000000000000 max=99999999999999 size=14
                        ...
                        <optgroup label="@lang('users.job')">
                            @foreach (App\Models\Role::select('name')->get() as $role)
                                <option value="{{ $role->name }}"
                                    {{ isset($row) ? ($row->hasRole($role->name) ? 'selected' : '') : '' }}>
                                    {{ $role->name }}
                                </option>
                            @endforeach
                        </optgroup>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="number" name="age" class="form-control" placeholder="@lang('users.age')" min=20 max=80
                        value="{{ $row->age ?? '' }}">
                </div>
