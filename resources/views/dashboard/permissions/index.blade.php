...
@section('sub_menu')
    <li class="breadcrumb-item active"> <i class="fa fa-hashtag"></i> @lang('general.' . getModel()) </li>
@endsection
                    ...
                    <table class="table" id="table">
                        <thead>
                            <tr>
                                ...
                                <th data-sort='display_name' data-order='desc'> @lang(getModel() . '.display_name') </th>
